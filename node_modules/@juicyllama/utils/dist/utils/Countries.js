...
class Countries {
    static convertISO2ToISO3(iso2) {
        if (!iso2 || (0, lodash_1.isNil)(iso2))
            return null;
        const ISO2toISO3 = {
            BD: 'BGD',
            BE: 'BEL',
    ...
    static countryNameToISO2(countryName) {
        if (!countryName || (0, lodash_1.isNil)(countryName))
            return null;
        try {
            const foundCountry = countries_json_1.default.find(country => country['Country Name'].toLowerCase() === countryName.toLowerCase());
    ...
    static getCountry(ISO2) {
        if (!ISO2 || (0, lodash_1.isNil)(ISO2))
            return;
        try {
            return countries_json_1.default.find(country => country.ISO2 === ISO2.toUpperCase());
        }
        catch (e) {
            const logger = new Logger_1.Logger();
